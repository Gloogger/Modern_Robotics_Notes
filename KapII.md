...
- (c) It will be (chassis on plane) times (the RRR joints) times (the limited P joint): $$\mathbb{R}^{2}\times \mathbb{S}^{1} \times \mathbb{S}^{1}\times \mathbb{S}^{1}\times \mathbb{S}^{1} \times [a,b]= \mathbb{R}^{2}\times \mathbb{S}^{2} \times \mathbb{T}^{3}\times [a,b] $$
- (d) It will be (rigid body in space) times (6R arm): $$\mathbb{R}^{3}\times \mathbb{S}^{2} \times \mathbb{S}^{1} \times \mathbb{T}^{6}}(\text{6R arm}) = \mathbb{R}^{3}\times \mathbb{S}^{2} \times \mathbb{T}^{7}$$
